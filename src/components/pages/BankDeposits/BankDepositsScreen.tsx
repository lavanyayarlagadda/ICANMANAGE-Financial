    ...
    const columns = useMemo<DataColumn<BankDepositItem>[]>(() => {
        ...
        const mappedColumns: DataColumn<BankDepositItem>[] = dynamicColumns.map(dc => {
            ...
            return {
                ...
                label: dc.displayName.toUpperCase(),
                align: 'center',
                accessor: (row: BankDepositItem) => (row as RowData)[actualField] as string | number | null,
                        ...
                        <Grid size={{ xs: 12, lg: 4 }}>
                            <SubSectionWrapper sx={{ height: '100%' }}>
                                ...
                                <Box sx={{ p: 0 }}>
                                    ...
                                    {historyData?.remitDataRecords?.map((remit: RemitHistoryItem, idx: number) => (
                        ...
                        <Grid size={{ xs: 12, lg: 4 }}>
                            <SubSectionWrapper sx={{ height: '100%' }}>
                                ...
                                <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                                    {historyData?.cashPostingRecords?.map((post: PostingHistoryItem, idx: number) => (
