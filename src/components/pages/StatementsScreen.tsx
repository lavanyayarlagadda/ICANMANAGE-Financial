...
import { setIsReloading } from '@/store/slices/uiSlice';
...
const StatementsScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (finalActiveSubTab === 1 && actionTriggers.reload > reloadCount.current) {
  ...
  }, [actionTriggers.reload, finalActiveSubTab, dispatch]);
