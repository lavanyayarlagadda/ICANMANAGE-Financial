            ...
            <ChartContainer>
                <ResponsiveContainer width="100%" height={350}>
                    <ComposedChart data={(() => {
                        ...
                        return (reconPerformance?.data || []).map((d: ReconPerformancePoint, index: number) => {
                            ...
                            return {
                                month,
                                actual: parseFloat(d.actualReconciledAmount || '0'),
                                forecast: parseFloat(d.forecastAmount || '0')
                            };
                        });
                    })()}>
