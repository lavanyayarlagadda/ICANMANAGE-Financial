...
export const legendIconStyles = (bg: string, border: string): any => ({
  width: 10,
  height: 10,
  borderRadius: '50%',
  backgroundColor: bg,
...
export const calendarCellStyles = (isSelected: boolean, isCurrentMonth: boolean, theme: any, isMobile: boolean, isTablet: boolean): any => ({
...
export const transactionBadgeStyles = (type: string): any => {
