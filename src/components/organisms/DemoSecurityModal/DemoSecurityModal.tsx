        ...
        <React.Fragment key={item.menuId}>
          <Box sx={styles.treeItemStyles(level, isLevel0, isLevel1, isParentDisabled)}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flex: 1, pr: 1 }}>
              {isLevel2 && <Box sx={styles.treeBulletStyles} />}
              ...
              >
                {MODULE_STATUS_OPTIONS.map((statusOption) => (
                  <MenuItem
                    key={statusOption}
                    value={statusOption}
                    sx={{ fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: 1 }}
                  >
    ...
    >
      ...
      <DialogActions sx={{ px: { xs: 2, sm: 3 }, pb: 2, justifyContent: 'space-between' }}>
        <Box
          ...
          alt="Logo"
          sx={{ height: 45, display: { xs: 'none', sm: 'block' } }}
        />
        <Box sx={{ display: 'flex', gap: 1 }}>
          ...
          <Button
            ...
            sx={{
              ...
              '&:disabled': { opacity: 0.5, backgroundColor: 'primary.main' },
            }}
          >
