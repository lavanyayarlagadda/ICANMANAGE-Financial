...
const DictionaryDrawer: React.FC<DictionaryDrawerProps> = ({ open, onClose, selectedField }) => {
  ...
  return (
    <Drawer
      ...
      onClose={onClose}
      sx={{
        zIndex: (theme) => theme.zIndex.drawer, // Sit exactly at drawer level (behind header)
        '& .MuiBackdrop-root': {
          top: { xs: '56px', md: '64px' },
        },
      }}
      ...
      >
        <Box
          sx={{
            ...
            mb: 3,
            flexShrink: 0,
            pt: 0, // Reset padding as high z-index handles clearance
            pb: 1,
        ...
        >
          ...
          >
            ...
            {selectedField.usageTip && (
              ...
              >
                <Typography
                  sx={{ fontSize: '0.85rem', fontWeight: 700, color: '#3b82f6', mb: 0.5 }}
                >
                  Usage Tip:
                </Typography>
          ...
          {selectedField.statuses && selectedField.statuses.length > 0 && (
            <Box sx={{ px: 2 }}>
              ...
              >
                <Box
                  component="span"
                  sx={{ width: 4, height: 16, bgcolor: '#3b82f6', borderRadius: 1 }}
                />
                STATUS EXPLANATIONS
              </Typography>
        ...
        <Box
          sx={{
            ...
            bgcolor: '#fafafa',
            mx: -4, // Counteract parent padding to span full width
            mb: -4, // Counteract parent padding
