      ...
      >
        <Box
          sx={{
            ...
            pb: 1,
            borderBottom: {
              xs: `1px solid ${themeConfig.colors.dictionaryDrawer.bgAlt}`,
              sm: 'none',
            },
          }}
        >
          ...
          <IconButton
            ...
            sx={{
              ...
              '&:hover': {
                bgcolor: themeConfig.colors.dictionaryDrawer.bgHover,
                color: themeConfig.colors.dictionaryDrawer.textHeading,
              },
              width: 36,
              height: 36,
            ...
            <Box sx={{ px: 2 }}>
              ...
              >
                <Box
                  ...
                  sx={{
                    width: 4,
                    height: 16,
                    bgcolor: themeConfig.colors.dictionaryDrawer.textAccent,
                    borderRadius: 1,
                  }}
                />
                STATUS EXPLANATIONS
              ...
              {selectedField.statuses.map((status, idx) => (
                <Box key={idx} sx={{ mb: 3, pl: 1.5 }}>
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: themeConfig.colors.dictionaryDrawer.textMuted, lineHeight: 1.6 }}
                  >
                    {status.explanation}
                  </Typography>
                </Box>
        ...
        >
          ...
          >
            ...
            <Typography
              variant="caption"
              sx={{ color: themeConfig.colors.dictionaryDrawer.textMuted, fontWeight: 600 }}
            >
              ICANMANAGE Support
            </Typography>
          </Box>
