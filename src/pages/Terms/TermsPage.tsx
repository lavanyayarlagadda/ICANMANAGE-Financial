          ...
          <TermsCard>
            ...
            <TermsContent>
              ...
              <SectionText>
                ...
                and Disclaimer Notice and any or all Agreements: <strong>"Client"</strong>,{' '}
                <strong>“You”</strong> and <strong>“Your”</strong> refers to you, the person
                ...
                and <strong>"Us"</strong>, refers to our Company. <strong>“Party”</strong>,{' '}
                <strong>“Parties”</strong>, or <strong>“Us”</strong>, refers to either the Client or
                ...
                provision of the Company’s stated services/products, following and subject to,
                prevailing American Law. Any use of the above terminology or other words in the
              ...
              <SectionText>
                The laws of the United States of America govern these terms and conditions. By
                accessing this website and using our services you consent to these terms and
                conditions and the exclusive jurisdiction of the USA courts in all disputes arising
                out of such access. If any of these terms are deemed invalid or unenforceable for
                any reason (including, but not limited to the exclusions and limitations set out
                above), then the invalid or unenforceable provision will be severed from these terms
                and the remaining terms will continue to apply. Failure of the Company to enforce
                any of the provisions set out in these Terms and Conditions and any Agreement, or
                failure to exercise any option to terminate, shall not be construed as a waiver of
                such provisions and shall not affect the validity of these Terms and Conditions or
                any Agreement or any part thereof, or the right thereafter to enforce every
              ...
              <SectionText>
                ...
                parties. However, Client records are regarded as confidential and therefore will not
                be divulged to any third party, other than [our manufacturer/supplier(s) and] if
                legally required to do so to the appropriate authorities. Clients have the right to
                request sight of, and copies of any and all Client Records we keep, on the proviso
                that we are given reasonable notice of such a request. Clients are requested to
                ...
                handouts or copies of records as part of an agreed contract, for the benefit of both
                parties.
              </SectionText>

              <SectionTitle variant="h5">Confidentiality</SectionTitle>
              <SectionText>
                We are registered under the Data Protection Act 1998. We are a covered entity and
                are permitted, but not required, to use and disclose protected health information,
                without an individual’s authorization, for the following purposes or situations: (1)
                To the Individual (unless required for access or accounting of disclosures); (2)
                Treatment, Payment, and Health Care Operations; (3) Opportunity to Agree or Object;
                (4) Incident to an otherwise permitted use and disclosure; (5) Public Interest and
                Benefit Activities; and (6) Limited Data Set for research, public health or health
                care operations. covered entities may rely on professional ethics and best judgments
                in deciding which of these permissive uses and disclosures to make.
              </SectionText>
              ...
              <SectionText>
                ...
                enable us to retrieve user details for each visit. Cookies are used in some areas of
                our site to enable the functionality of this area and ease of use for those people
              ...
              <SectionText>
                ...
                with third parties and is used only within this Company on a need-to-know basis. Any
              ...
              <SectionText>
                This Company’s logo is a registered trademark of this Company in the United State of
                America and other countries. The brand names and specific services of this Company
                featured on this web site are trademarked.
              </SectionText>
              ...
              <SectionText>
                ...
                consent. If you do create a link to a page of this website, you do so at your own
                risk and the exclusions and limitations set out above will apply to your use of this
