    ...
    <DashboardLayout>
      <Box sx={{ maxWidth: 800, margin: '0 auto', py: 2 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
          <IconButton
            onClick={() => navigate(-1)}
            sx={{ mr: 1, color: themeConfig.colors.text.primary }}
          >
            <ArrowBackIcon />
          </IconButton>
        ...
        {/* Tabs navigation */}
        <Box
          sx={{ backgroundColor: themeConfig.colors.surfaceAlt, borderRadius: 2, p: 0.5, mb: 3 }}
        >
          <Tabs
            value={tabIndex}
        ...
        <TabPanel value={tabIndex} index={1}>
          <Card sx={{ p: 3, border: `1px solid ${themeConfig.colors.border}`, boxShadow: 'none' }}>
            ...
            <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2 }}>
              Use 8+ characters with uppercase, lowercase, numbers, and special characters. Avoid
