          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Box
              sx={{
                ...
                width: '100%',
                background: (t) =>
                  `linear-gradient(45deg, ${t.palette.grey[50]} 25%, transparent 25%, transparent 75%, ${t.palette.grey[50]} 75%, ${t.palette.grey[50]}), linear-gradient(45deg, ${t.palette.grey[50]} 25%, transparent 25%, transparent 75%, ${t.palette.grey[50]} 75%, ${t.palette.grey[50]})`,
