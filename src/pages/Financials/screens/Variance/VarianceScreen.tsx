    ...
    return (
        <ScreenWrapper>
            ...
            <Grid container spacing={2} sx={{ mb: 4 }}>
                ...
                <Grid size={{ xs: 12, md: 4 }}><SummaryCard title={summaryValues.lbl2} value={formatCurrency(summaryValues.tAct)} backgroundColor="background.paper" /></Grid>
                <Grid size={{ xs: 12, md: 4 }}><SummaryCard title="LEAKAGE" value={formatCurrency(summaryValues.tLeak)} backgroundColor="background.paper" /></Grid>
            </Grid>
