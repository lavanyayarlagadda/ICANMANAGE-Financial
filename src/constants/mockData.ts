...
export const mockReconciliationRows: ReconciliationRow[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    location: 'FL',
    reconcileDate: '2026-03-26'
  },
  {
    id: '4',
    transactionNo: 'EFT-889900',
    transactionType: 'EFT CREDIT',
    batchOwner: 'ICAN',
    accountName: 'Surgical Center Deposits',
    payor: 'Aetna Medicare',
    depositDate: '2026-04-01',
    bankDeposit: 15420.50,
    remittance: 15420.50,
    amd: 15420.50,
    nextGenCore: 15420.50,
    nextGenPcsd: 0,
    legacy: 0,
    gl: 15420.50,
    unapplied: 0,
    variance: 0,
    status: 'Reconciled',
    complexStatus: ['Match', 'Auto-Matched'],
    location: 'TX',
    reconcileDate: '2026-04-02'
  },
  {
    id: '5',
    transactionNo: 'CHK-123456',
    transactionType: 'CHECK',
    batchOwner: 'PendingUser',
    accountName: 'General Hospital Account',
    payor: 'Blue Cross Blue Shield',
    depositDate: '2026-04-02',
    bankDeposit: 2500.00,
    remittance: 2400.00,
    amd: 0,
    nextGenCore: 2400.00,
    ...
    variance: -100.00,
    status: 'Unreconciled',
    complexStatus: ['Variance > 5%', 'Manual Action'],
    location: 'NC',
    isEdited: false
  },
  {
    id: '6',
    transactionNo: 'EFT-776655',
    transactionType: 'EFT CREDIT',
    batchOwner: 'ICAN',
    accountName: 'Wellness Center Deposits',
    payor: 'UnitedHealthcare',
    depositDate: '2026-04-03',
    bankDeposit: 12000.00,
    remittance: 11500.00,
    amd: 11500.00,
    nextGenCore: 11500.00,
    nextGenPcsd: 0,
    legacy: 0,
    gl: 11500.00,
    unapplied: 500.00,
    variance: -500.00,
    status: 'Unreconciled',
    complexStatus: ['Manual adjustment needed'],
    location: 'OH',
    isEdited: true,
    comment: 'Manual adjustment needed'
  },
  {
    id: '7',
    transactionNo: 'CHK-998877',
    transactionType: 'CHECK',
    batchOwner: 'RECON',
    accountName: 'Main Hospital Account',
    payor: 'Aetna',
    depositDate: '2026-04-04',
    bankDeposit: 5000.00,
    remittance: 5000.00,
    amd: 5000.00,
    nextGenCore: 5000.00,
    ...
    location: 'CA',
    isEdited: false,
    reconcileDate: '2026-04-05'
  },
  {
    id: '8',
    transactionNo: 'EFT-112244',
    transactionType: 'EFT CREDIT',
    batchOwner: 'ICAN',
    accountName: 'General Hospital Account',
    payor: 'CIGNA',
    ...
    variance: -819.72,
    status: 'Unreconciled',
    complexStatus: ['Remit missing'],
    location: 'AZ',
    isEdited: true,
    comment: 'Incorrect deposit date'
  }
];
