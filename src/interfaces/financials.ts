...
export interface BankDepositItem {
  id?: string;
  acaciaPostingAmount?: number | null;
  accountName: string;
  accountNo: string;
  age?: number | null;
  amdPostingAmount: number;
  aprimaAmnt?: number | null;
  baiAmount: number;
  baiAmountStr?: string | null;
  baiReceivedDate: string;
  batchOwner: string;
  ...
  emrAmount?: number | null;
  excelDownloadId?: number | null;
  fkBaiDataId?: number;
  fkBankMasterId?: number;
  fkPayerId?: number;
  fkRemitDataId?: number;
  fkStateId?: number;
  fkTransactionTypeId?: number;
  glPostingAmount?: number | null;
  isManualUpdated?: string;
  isRemitReceived?: number;
  mcareAmnt?: number | null;
  ...
  pkNonReconciledId?: number | null;
  postingFileTypeId?: number | null;
  reconciledDate?: string | null;
  reconciliationStatus?: string | null;
  remitAmount: number;
  remitReceivedDate?: string;
  resultPageNumber?: number | null;
  resultPageSize?: number | null;
  stateName: string;
  status: string | null;
  ...
  totalRows: number;
  transactionEditId?: number;
  transactionNo: string;
  transactionType: string;
  unDistributedAmount?: number | null;
  unappliedAmount?: number | null;
  userRoleId?: number;
  variance1: number;
  variance1Status: string;
  variance2: number;
  variance2Status: string;
  varianceAmount: number;
  varianceType: string;
  workQueueTotalsVO?: {
    totalDeposit: number;
    totalDistributed: number;
    totalEpicPosting: number;
    totalNotPosted: number;
    totalPayVariance: number;
    totalPostVariance: number;
